...
from lueur.platform.gcp.project import list_organization_projects, list_all_projects


@respx.mock
@pytest.mark.asyncio
async def test_list_organization_projects(gcp_org_id: str, gcp_project: str) -> None:
    respx.post(
...
async def test_list_all_projects(gcp_org_id: str, gcp_project: str) -> None:
    ...
    assert await list_all_projects() == [GCPProject(
