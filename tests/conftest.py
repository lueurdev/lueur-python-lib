...
def gcp_cloudrun_service_account_A(
    ...
    return f"{gcp_cloudrun_service_A}-yxvjljk5@{gcp_project_number}.iam.gserviceaccount.com",
...
def gcp_cloudrun_service_account_B(
    ...
    return f"{gcp_cloudrun_service_B}-pxwytzo5@{gcp_project_number}.iam.gserviceaccount.com",
